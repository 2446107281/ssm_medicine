        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">简单的表格</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
      ...
      <div class="container-fluid">
                ...
                <table class="table table-hover text-nowrap">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td>John Doe</td>
                      <td>11-7-2014</td>
                      <td><span class="tag tag-success">批准</span></td>
                      <td>培根，意大利熏肉，意大利腊肠，鹿肉，鸡肉，肥肉。</td>
                    </tr>
                    <tr>
                      <td>219</td>
                      <td>Alexander Pierce</td>
                      <td>11-7-2014</td>
                      <td><span class="tag tag-warning">等待</span></td>
                      <td>培根，意大利熏肉，意大利腊肠，鹿肉，鸡肉，肥肉。</td>
                    </tr>
                    <tr>
                      <td>657</td>
                      <td>Bob Doe</td>
                      <td>11-7-2014</td>
                      <td><span class="tag tag-primary">批准</span></td>
                      <td>培根，意大利熏肉，意大利腊肠，鹿肉，鸡肉，肥肉。</td>
                    </tr>
                    <tr>
                      <td>175</td>
                ...
                <table class="table table-bordered table-hover">
                  ...
                  <tbody>
                    ...
                    <tr class="expandable-body">
                      <td colspan="5">
                        <p>
                          Lorem Ipsum 只是印刷和排版行业的虚拟文本。 自 15世纪以来，Lorem Ipsum 一直是该行业的标准虚拟文本， 当时一台不知名的打印机把一堆字拼凑在一起，做成了一本样书。 它不仅生存了五个世纪，而且跃进到电子排版，基本上保持不变。 20世纪60年代，随着包含 Lorem Ipsum 段落的莱斯泰特纸张的发布， 以及最近的包括 Lorem Ipsum 版本在内的 AldusPageMaker 桌面出版软件的发布， 它得到了普及。
                        </p>
                      </td>
                    </tr>
        ...
        <div class="row">
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">树形可扩展表格</h3>
              </div>
              <!-- ./card-header -->
              <div class="card-body p-0">
