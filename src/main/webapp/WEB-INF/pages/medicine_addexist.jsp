...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">添加已存在的药品</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
      ...
      <!-- 主体内容 -->
      <form action="medicine_addexist_action" method="post">
                      ...
                      <div class="card card-primary">
                          ...
                          <div class="card-body">
                              <div class="form-group">
                                  <input type="hidden" id="inputM_id" name="M_id" class="form-control" value="${requestScope.medicine.m_id}" >
                              </div>
                              <div class="form-group">
                              ...
                              <div class="form-group">
                                  <label for="inputM_in_much">要添加的药品的数量</label>
                                  <input type="text" id="inputM_in_much" name="M_in_much" class="form-control" value="0"/>
                              </div>
                              <div class="form-group">
